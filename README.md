...
- Clone the starter
  ...
  ```sh
  git clone git@github.com:BR4GR/nvim.git ~/.config/nvim
  ```

  or
  
  ```sh
  git clone https://github.com/BR4GR/nvim.git ~/.config/nvim
  ```
...
Refer to the [docs](https://lazyvim.github.io).io/installation) to get started.
